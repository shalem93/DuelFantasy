            ...
            VStack(spacing: 8) {
                ...
                case "EPL", "UCL", "WC":
                    Text("Outfield (DEF / MID / FWD)")
                        ...
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: .leading)
                    scoringRow(label: "Goal", value: "+10 FPTS")
                    scoringRow(label: "Assist", value: "+6 FPTS")
                    scoringRow(label: "Shot", value: "+1 FPTS")
                    scoringRow(label: "Shot on Goal", value: "+1 FPTS")
                    scoringRow(label: "Shot Assist", value: "+1 FPTS")
                    scoringRow(label: "Tackle Won", value: "+1 FPTS")
                    scoringRow(label: "Foul Drawn", value: "+1 FPTS")
                    scoringRow(label: "Cross", value: "+0.7 FPTS")
                    scoringRow(label: "Interception", value: "+0.5 FPTS")
                    scoringRow(label: "Accurate Pass", value: "+0.02 FPTS")
                    scoringRow(label: "Foul Conceded", value: "-0.5 FPTS")
                    scoringRow(label: "Yellow Card", value: "-1.5 FPTS")
                    ...
                    Text("Defenders Only")
                        ...
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: .leading)
                    scoringRow(label: "Clean Sheet", value: "+3 FPTS")
                    Divider()
                    Text("Goalkeeper")
                        .font(.caption.weight(.bold))
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: .leading)
                    scoringRow(label: "Save", value: "+2 FPTS")
                    scoringRow(label: "Goal Against", value: "-2 FPTS")
                    scoringRow(label: "Clean Sheet", value: "+5 FPTS")
                    scoringRow(label: "Win Bonus", value: "+5 FPTS")
                case "UFC":
                    Text("Striking")
                        .font(.caption.weight(.bold))
                        .foregroundStyle(.secondary)
                ...
                case "NFL", "CFB":
                    Text("Offense")
                        ...
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: .leading)
                    scoringRow(label: "Passing Yard", value: "+0.04 FPTS")
                    scoringRow(label: "Passing TD", value: "+4 FPTS")
                    scoringRow(label: "Interception", value: "-1 FPTS")
                    scoringRow(label: "Rushing Yard", value: "+0.1 FPTS")
                    scoringRow(label: "Rushing TD", value: "+6 FPTS")
                    scoringRow(label: "Reception", value: "+1 FPTS")
                    scoringRow(label: "Receiving Yard", value: "+0.1 FPTS")
                    scoringRow(label: "Receiving TD", value: "+6 FPTS")
                    scoringRow(label: "Fumble Lost", value: "-1 FPTS")
                    scoringRow(label: "2-Pt Conversion", value: "+2 FPTS")
                    Divider()
                    Text("Bonuses")
                        .font(.caption.weight(.bold))
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: .leading)
                    scoringRow(label: "300+ Pass Yards", value: "+3 FPTS")
                    scoringRow(label: "100+ Rush Yards", value: "+3 FPTS")
                    scoringRow(label: "100+ Rec Yards", value: "+3 FPTS")
                case "NASCAR":
                    Text("Race Finish")
                        .font(.caption.weight(.bold))
                        .foregroundStyle(.secondary)
